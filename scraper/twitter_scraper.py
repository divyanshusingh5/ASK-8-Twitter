...
- Twitter is experiencing unusual activity"""
    ...
    def save_to_csv(self):
        ...
        data = {
    "id": [f"tweet_id:{tweet[14]}" for tweet in self.data],
    "created_at": [tweet[2] for tweet in self.data],
    "updated_at": [""] * len(self.data),  # Assuming this field is not available
    "reference_id": [""] * len(self.data),  # Assuming this field is not available
    "title": [tweet[4] for tweet in self.data],
    "author": [tweet[1] for tweet in self.data],
    "url": [tweet[13] for tweet in self.data],
    "hostname": [tweet[0] for tweet in self.data],
    "description": [tweet[3] for tweet in self.data],
    "crawled_at": [""] * len(self.data),  # Assuming this field is not available
    "published_at": [""] * len(self.data),  # Assuming this field is not available
    "categories": [""] * len(self.data),  # Assuming this field is not available
    "stocks": [[]] * len(self.data),  # Assuming this field is not available
    "classes": [[]] * len(self.data),  # Assuming this field is not available
    "indices": [[]] * len(self.data),  # Assuming this field is not available
    "stock_names": [[]] * len(self.data),  # Assuming this field is not available
    "summary": [None] * len(self.data),  # Assuming this field is not available
    "companies": [[]] * len(self.data),  # Assuming this field is not available
    "sentiment": [None] * len(self.data)  # Assuming this field is not available
}
    ...
    def save_to_json(self):
            ...
            data = [
                {
                    "id": f"tweet_id:{tweet[14]}",
                    "created_at": tweet[2],
                    "updated_at": "",  # Assuming this field is not available
                    "reference_id": "",  # Assuming this field is not available
                    "title": tweet[4],
                    "author": tweet[1],
                    "url": tweet[13],
                    "hostname": tweet[0],
                    "description": tweet[3],
                    "crawled_at": "",  # Assuming this field is not available
                    "published_at": "",  # Assuming this field is not available
                    "categories": "",  # Assuming this field is not available
                    "stocks": [],  # Assuming this field is not available
                    "classes": [],  # Assuming this field is not available
                    "indices": [],  # Assuming this field is not available
                    "stock_names": [],  # Assuming this field is not available
                    "summary": None,  # Assuming this field is not available
                    "companies": [],  # Assuming this field is not available
                    "sentiment": None  # Assuming this field is not available
                }
            ...
            if self.scraper_details["poster_details"]:
                for i, tweet in enumerate(self.data):
                    data[i]["Tweeter ID"] = f"user_id:{tweet[15]}"
                    data[i]["Following"] = tweet[16]
                    data[i]["Followers"] = tweet[17]
